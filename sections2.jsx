...
function IPhone17Call({ play }) {
  ...
  const TRANSCRIPT = [
    { delay: 500,  text: "Hola James 👋 soy Sarah, de Logistics.com" },
...
function Security({ t }) {
  const es = isEs(t);
  const items = es ? [
    { title: "Privacidad de datos por defecto", desc: "Cada llamada, transcripción y evento queda cifrado en tránsito y en reposo. Firmamos DPAs listos para usar y cumplimos con GDPR y normativas locales de protección de datos.", icon: "verified_user",       gradient: "sec-g1" },
